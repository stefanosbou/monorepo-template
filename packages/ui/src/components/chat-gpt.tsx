      ...
      <ThreadPrimitive.Viewport className="flex grow flex-col gap-8 overflow-y-scroll pt-16">
        <ThreadPrimitive.Empty>
          <div className="flex grow flex-col items-center justify-center">
            <Avatar className="flex h-12 w-12 items-center justify-center rounded-3xl border border-white/15 shadow">
...
const AssistantMessage: FC = () => {
  return (
    <MessagePrimitive.Root className="relative mx-auto flex w-full max-w-3xl gap-3">
      <Avatar className="flex size-8 shrink-0 items-center justify-center rounded-3xl border border-white/15 shadow">
